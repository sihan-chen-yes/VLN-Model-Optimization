name=in_static_out_dy_rl+clip-valid-REVERIE-load
flag="--attn soft --train validlistener --task REVERIE
      --featdropout 0.3 --load snap/in_static_out_dy_rl+clip-valid-REVERIE-load/state_dict/best_val_unseen
